...
# Prefer the project's bundled dependencies when launched with `python app.py`.
_site_packages = os.path.join(os.path.dirname(__file__), 'venv', 'Lib', 'site-packages')
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', debug=False, port=5000, load_dotenv=False)
